...
export type CanvasNodeType = "image" | "text" | "config" | "video" | "audio" | "group";
...
export type CanvasSnapshot = { projectId?: string; title?: string; nodes?: CanvasNode[]; connections?: CanvasConnection[]; selectedNodeIds?: string[]; viewport?: Viewport; clientId?: string; hasCanvas?: boolean; active?: boolean; updatedAt?: number };
